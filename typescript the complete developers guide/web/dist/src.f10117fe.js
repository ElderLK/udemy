...
function (_super) {
  ...
  function UserForm() {
    ...
    _this.onButtonSetName = function () {
...
},{"./UserForm":"src/views/UserForm.ts","./UserShow":"src/views/UserShow.ts","./View":"src/views/View.ts"}],"src/models/Attributes.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  Object.defineProperty(Model.prototype, "on", {
    /*
        on = this.events.on; short syntax
    */
    get: function get() {
...
},{"./views/UserEdit":"src/views/UserEdit.ts","./models/User":"src/models/User.ts"}],"../../../../.nvm/versions/node/v12.18.3/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
